...
export const portfolio: Spread[] = [
  ...
  },
  {
    name: 'Bodega',
    statement:
      'The main product store connecting enterprise releases, essentials, and original product worlds through one commerce destination.',
    category: 'Commerce · Main store',
    location: 'Online',
    status: 'Operating',
    image: '/brand-logos/bodega.png',
    fit: 'contain',
  ...
  },
  {
    name: 'Hakuna Matata',
    statement:
      'The founder’s field manual for living now, building next, and keeping ambition connected to a life worth having.',
    category: 'Publishing · Founder media',
    location: 'Available worldwide',
    status: 'Available now',
    image: '/dorsey/book-cover.png',
    fit: 'contain',
    href: 'https://bodgeaworldwide.myshopify.com/products/hakuna-matata-by-dr-dorsey',
    cta: 'Buy the book',
  },
  {
    name: 'STUSH',
  ...
  },
  {
    ...
    statement:
      'Atlanta identity made tangible through apparel, graphics, and cultural products rooted in the city.',
    category: 'Commerce · Atlanta culture',
    location: 'Atlanta',
    status: 'Active',
    image: '/brand-logos/make-atlanta-great-again.png',
    fit: 'contain',
  ...
  },
  {
    ...
    statement:
      'Twelve original food identities designed for delivery, food halls, licensing, and multi-unit expansion.',
    category: 'Food & Beverage · 12 brands',
    location: 'Atlanta · Multi-market licensing',
    status: 'Operating',
    image: '/brand-logos/casper-group.png',
    video: '/dorsey/motion/casper-group.mp4',
    fit: 'contain',
    href: 'https://caspergroupworldwide.com',
    cta: 'Explore Casper',
  },
  {
    name: 'Infinity Water',
    statement:
      'Luxury water with a distinct bottle, a distinct experience, and a longer infrastructure thesis behind it.',
    category: 'Beverage · Water',
    location: 'Atlanta',
    status: 'Active',
    image: '/dorsey/current/infinity-water.jpg',
    video: 'https://sccmgpssfwhgxefbdwbc.supabase.co/storage/v1/object/public/entity-motion/dorsey/infinity-water.mp4',
