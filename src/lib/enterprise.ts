...
const focusBrandRoster: BrandCard[] = [
  ...
  {
    name: 'BEVCO INTL.',
    category: 'Beverage House · Portfolio',
    href: 'https://bevco-intl.vercel.app',
    status: 'Beverage House',
  ...
  {
    name: 'ICONIC',
    category: 'Live Entertainment · Concerts · Music',
    href: 'https://iconic-atl.com',
    status: 'Live Entertainment',
    actionLabel: 'Enter ICONIC',
    destinationType: 'website',
  },
  {
    name: 'FĚNYX',
