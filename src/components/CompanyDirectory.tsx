...
// Section anchors come from departmentSlug() so the department cards' hrefs
// and the anchors they land on are generated by the same function.
...
export default function CompanyDirectory() {
  ...
  /**
   * The fourteen departments, in their canonical order.
   *
   * Grouped by department rather than by the registry's older eight-way
   * `division`, so this page names the same fourteen the homepages and both
   * apps do. A viewer should not meet one vocabulary on the home page and a
   * different one a click later.
   */
