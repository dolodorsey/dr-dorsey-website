...
export const brands: Brand[] = [
  ...
  { name: 'Infinity Water', division: 'Products', status: 'active', website: 'https://watertoinfinity.com' },
  { name: 'Pronto Energy', division: 'Products', status: 'active', logo: `${SB}/pronto_energy/logos/pronto-logo.png`, website: 'https://prontoenergydrink.com' },
  { name: 'NOIR', division: 'Events', status: 'active', logo: `${SB}/noir_event/01_logos/NOIR_LOGO.png`, flyer: `${SB}/noir_event/03_event_flyers/NOIR_NEWS.png`, website: 'https://noir-event.vercel.app' },
  { name: 'Taste of Art', division: 'Events', status: 'active', logo: `${SB}/taste_of_art/01_logos/TASTE_OF_ART_LOGO.png`, flyer: `${SB}/taste_of_art/03_event_flyers/TASTE_MAIN2.JPEG`, website: 'https://taste-of-art-event.vercel.app' },
  { name: 'REMIX', division: 'Events', status: 'active', logo: `${SB}/remix_event/01_logos/REMIX_LOGO.png`, flyer: `${SB}/remix_event/03-event-flyers/remix-dj-dates-cities.png`, website: 'https://remix-event.vercel.app' },
  { name: 'Gangsta Gospel', division: 'Events', status: 'seasonal', logo: `${SB}/gangsta_gospel/01_logos/GANGSTA_GOSPEL_LOGO.png`, flyer: `${SB}/gangsta_gospel/03_event_flyers/GANGSTA_DATE.png`, website: 'https://gangsta-gospel-event.vercel.app' },
